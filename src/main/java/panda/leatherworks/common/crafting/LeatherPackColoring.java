...
public class LeatherPackColoring extends Impl<IRecipe> implements IRecipe{
	
	public LeatherPackColoring() {
	    this.setRegistryName(new ResourceLocation(LeatherWorks.MODID,"leatherpackcoloring"));
	  }
	/**
	...
	public boolean matches(InventoryCrafting inv, World worldIn)
	{
		...
		for (int k = 0; k < inv.getSizeInventory(); ++k)
		{
			...
			{
				if (itemstack.getItem() instanceof ItemPack && itemstack.getItem() == LWItems.PACK_BROWN)
	...
	public ItemStack getCraftingResult(InventoryCrafting inv)
	{
		...
		for (int i = 0; i < inv.getSizeInventory(); ++i)
		{
			...
			{
				if (itemstack2.getItem() instanceof ItemPack)
				{
		...
		ItemStack itemstack3 = ItemPack.getColoredItemStack(DyeUtils.colorFromStack(itemstack1).get());
